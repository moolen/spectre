import { r as reactExports, u as useSettings, j as jsxRuntimeExports, R as React, a as useSearchParams, N as NavLink, b as Routes, c as Route } from './index-rD0dd41P.js';
import { f as formatDateTimeForInput, v as validateTimeRange, T as TimeInputWithCalendar, g as getDemoMode, a as apiClient, p as parseTimeExpression, t as toast, b as Toaster, S as SettingsPage } from './SettingsPage-DlyVciZE.js';
            ...
            return /* @__PURE__ */ jsxRuntimeExports.jsxs(
              "div",
              {
                ...
                children: [
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-sm select-none", children: option })
                ]
              },
              option
            );
...
const FilterBar = ({ filters, setFilters, timeRange, onTimeRangeChange, availableNamespaces, availableKinds, rawStart, rawEnd }) => {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "w-full bg-[var(--color-surface-elevated)]/95 backdrop-blur border-b border-[var(--color-border-soft)] p-4 flex flex-row gap-6 items-center shadow-lg z-30 text-[var(--color-text-primary)] transition-colors duration-300", children: [
    getDemoMode() && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "px-3 py-1 rounded-full bg-amber-500/20 border border-amber-500/40 flex items-center gap-2 min-w-max", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-2 h-2 rounded-full bg-amber-400 animate-pulse" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs font-semibold text-amber-300", children: "Demo Mode" })
    ] }),
...
const DetailPanel = ({ resource, selectedIndex = 0, onClose }) => {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "div",
    {
      ...
      children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "p-3 bg-[var(--color-surface-secondary)] border-t border-[var(--color-border-soft)] text-center text-xs text-[var(--color-text-muted)]", children: "Use Arrow Left/Right to navigate history" })
      ]
    }
  );
};
...
const loadFilters = (defaultKinds) => {
  ...
  try {
    ...
    const kinds = kindsStr ? JSON.parse(kindsStr) : defaultKinds;
    const namespaces = namespacesStr ? JSON.parse(namespacesStr) : [];
    return {
      kinds: Array.isArray(kinds) ? kinds : defaultKinds,
...
const usePersistedFilters = (availableKinds, availableNamespaces, defaultKinds) => {
  ...
  reactExports.useEffect(() => {
    ...
    setFilters((prev) => {
      const validatedKinds = availableKinds.length > 0 ? prev.kinds.filter((kind) => availableKinds.includes(kind)) : prev.kinds;
  ...
  ({ data, onNodeClick, selectedNodeId, highlightedNodeUids, width: propWidth, height: propHeight }, ref) => {
    ...
    reactExports.useEffect(() => {
      ...
      if (isReset) {
        ...
        const simulation$1 = simulation(simulationNodes).force("charge", manyBody().strength(-400)).force("center", center(width / 2, height / 2)).force("collision", collide().radius(COLLISION_RADIUS)).force(
          "link",
          link$2(simulationLinks).id((d) => d.uid).distance(100).strength(0.5)
        );
        simulation$1.stop();
        for (let i = 0; i < 300; i++) {
          simulation$1.tick();
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "div",
    {
      ...
      children: [
        ...
        ] }) }) : causalPaths.length > 0 ? /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "divide-y divide-[var(--color-border-soft)]", children: causalPaths.map((path, index) => {
            ...
            "div",
            {
              ...
              children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mb-2", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-[9px] text-[var(--color-text-muted)] uppercase mb-0.5", children: "Root Cause" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-xs font-semibold text-[var(--color-text-primary)]", children: [
                ...
                isSelected && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-3 pt-3 border-t border-[var(--color-border-soft)]", children: [
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-1", children: path.steps.map((step, stepIndex) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
                    "div",
                    {
                      ...
                      children: [
                        ...
                        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 min-w-0", children: [
                          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-[10px] text-[var(--color-text-primary)] truncate", children: [
...
function NamespaceGraphPage() {
  ...
  const graphTimestamp = reactExports.useMemo(() => /* @__PURE__ */ new Date(), [selectedNamespace]);
  reactExports.useEffect(() => {
  ...
  const filteredData = reactExports.useMemo(() => {
    if (!data) return null;
    const filteredNodes = selectedKinds.length > 0 ? data.graph.nodes.filter((node) => selectedKinds.includes(node.kind)) : [];
...
const navItems = [
  ...
  },
  {
    ...
    label: "Agents",
    icon: /* @__PURE__ */ jsxRuntimeExports.jsxs("svg", { xmlns: "http://www.w3.org/2000/svg", width: "20", height: "20", viewBox: "0 0 24 24", fill: "none", stroke: "currentColor", strokeWidth: "2", strokeLinecap: "round", strokeLinejoin: "round", "aria-hidden": "true", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("path", { d: "M16.247 7.761a6 6 0 0 1 0 8.478" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("path", { d: "M19.075 4.933a10 10 0 0 1 0 14.134" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("path", { d: "M4.925 19.067a10 10 0 0 1 0-14.134" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("path", { d: "M7.753 16.239a6 6 0 0 1 0-8.478" }),
...
const PlaceholderPage = ({ title }) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { padding: "24px", color: "#ffffff" }, children: [
  /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { style: { fontSize: "24px", fontWeight: 600, marginBottom: "16px" }, children: title }),
  /* @__PURE__ */ jsxRuntimeExports.jsx("p", { style: { color: "#a0a0a0" }, children: "This page is under construction." })
] });
function App() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: appContainerStyles, children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("main", { style: mainContentStyles, children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs(Routes, { children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(Route, { path: "/agents", element: /* @__PURE__ */ jsxRuntimeExports.jsx(PlaceholderPage, { title: "Agents" }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(Route, { path: "/dashboards", element: /* @__PURE__ */ jsxRuntimeExports.jsx(PlaceholderPage, { title: "Dashboards" }) }),
...
//# sourceMappingURL=App-CN82QFaE.js.map
