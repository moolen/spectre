...
- IngestBatch method already exists in client.go (created in Plan 03-01)
  </action>
  <verify>
go build ./internal/integration/victorialogs/... succeeds
...
grep -r "client.IngestBatch" internal/integration/victorialogs/pipeline.go confirms wiring to client
  </verify>
  <done>
...
Pipeline calls client.IngestBatch to send batched logs
...
- Pipeline calls client.IngestBatch (method created in Plan 03-01)
</verification>
...
6. Pipeline correctly calls client.IngestBatch method
7. All code compiles without errors and follows project conventions
</success_criteria>
